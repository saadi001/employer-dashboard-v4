    ...
    <div className="h-screen flex overflow-hidden">
      ...
      <aside className="w-[300px] flex-shrink-0 flex flex-col text-textColor border-r border-gray-100">
        ...
        <div className="px-6 py-5 relative">
          ...
          <div className="border rounded-full bg-white absolute top-1/2 -translate-y-1/2  -right-3 w-6 h-6 flex items-center justify-center cursor-pointer hover:bg-slate-100 z-20">
